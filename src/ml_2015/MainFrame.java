...
public class MainFrame {
	...
	private void initialize() {
		...
		product_label_1 = new JLabel("‘ﬂÙÎÔÚ");
		...
		product_label_3 = new JLabel(" ·ÙÁ„ÔÒﬂ·");
		...
		product_label_4 = new JLabel("’ÔÍ·ÙÁ„ÔÒﬂ·");
		...
		product_label_5 = new JLabel("‘ÈÏﬁ");
		...
		product_label_7 = new JLabel("–ÔÛ¸ÙÁÙ·");
		...
		product_label_8 = new JLabel("¡ÒÈËÏ¸Ú ÛÙÔÈ˜ÂﬂÔı");
		...
		//To label pou tha emfanizetai otan ena neo proion dhmiourgithei me epityxia
		edit_product_label_done = new JLabel("\u2713 « ÂÂÓÂÒ„·Ûﬂ· ÙÔı ÒÔ˙¸ÌÙÔÚ ›„ÈÌÂ ÏÂ ÂÈÙı˜ﬂ·!");
