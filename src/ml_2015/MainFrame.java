...
public class MainFrame {
	...
	private void initialize() {
		...
		JLabel label_task_1 = new JLabel("пяобокг апохелатос пяозомтос");
		label_task_1.setBounds(0, 55, 500, 25);
		...
		JLabel label_task_2 = new JLabel("пяобокг апохелатос пяозомтос");
		label_task_2.setBounds(0, 55, 500, 25);
		...
		JLabel label_task_3 = new JLabel("пяобокг апохелатос пяозомтос");
		label_task_3.setBounds(0, 55, 500, 25);
		...
		JLabel label_task_4 = new JLabel("пяобокг апохелатос пяозомтос");
		label_task_4.setBounds(0, 55, 500, 25);
		...
		JLabel label_task_5 = new JLabel("пяобокг апохелатос пяозомтос");
		label_task_5.setBounds(0, 55, 500, 25);
