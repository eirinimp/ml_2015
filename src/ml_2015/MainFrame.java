...
public class MainFrame {
	...
	private void initialize() {
		...
		label_task_1 = new JLabel("дглиоуяциа меоу пяозомтос");
		...
		label_task_2 = new JLabel("пяобокг апохелатос пяозомтос");
		...
		label_task_3 = new JLabel("епенеяцасиа апохелатос пяозомтос");
		...
		label_task_4 = new JLabel("амафгтгсг ста апохелата");
		...
		label_task_5 = new JLabel("елжамисг статистийым стоивеиым");
				...
				if ( typeOfUser.equals("admin") ){
					...
					button_1.addActionListener(new ActionListener(){
						public void actionPerformed(ActionEvent e){
							...
							new_product_label_1 = new JLabel("тъТКОР");
							...
							new_product_label_3 = new JLabel("йАТГЦОЯъА");
							...
							new_product_label_4 = new JLabel("уПОЙАТГЦОЯъА");
							...
							new_product_label_5 = new JLabel("тИЛч");
							...
							new_product_label_6 = new JLabel("ж.п.а.");
							...
							new_product_button = new JButton("дглиоуяциа");
					...
					button_4.addActionListener(new ActionListener(){
						public void actionPerformed(ActionEvent e){
							...
							search_btn = new JButton("амафгтгсг");
